...
const getSlotValues = async (url, contractAddress, slotKeys, blockTag = 'latest') => {
    try {
        ...
        const missingKeys = SlotValueCache_1.SlotValueCache.missingSlotKeys(slotKeys);
        ...
        return SlotValueCache_1.SlotValueCache.addCache(slotKeys, missingKeys, missingValues);
    }
    catch (err) {
