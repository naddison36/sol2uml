    ...
    try {
        ...
        if (combinedOptions.data) {
            ...
            for (const storageSection of storageSections) {
                await (0, slotValues_1.addSlotValues)(combinedOptions.url, storageAddress, storageSection, block);
            }
            // Add storage variables for dynamic arrays, strings and bytes
            await (0, converterClasses2Storage_1.addDynamicVariables)(storageSections[0], storageSections, combinedOptions.url, storageAddress, block);
        }
