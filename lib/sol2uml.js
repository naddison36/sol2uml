    ...
    try {
        ...
        if (combinedOptions.data) {
            ...
            for (const storageSection of storageSections) {
                await (0, converterClasses2Storage_1.addStorageValues)(combinedOptions.url, storageAddress, storageSection, combinedOptions.block);
            }
            // Add storage variables for dynamic arrays
            (0, converterClasses2Storage_1.addDynamicArrayVariables)(storageSections[0], storageSections);
        }
